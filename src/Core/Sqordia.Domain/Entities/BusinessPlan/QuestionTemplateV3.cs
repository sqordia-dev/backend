...
/// </summary>
public class QuestionTemplateV3 : BaseAuditableEntity
{
    /// <summary>
    ...
    private QuestionTemplateV3() { } // EF Core constructor

    public QuestionTemplateV3(
        int questionNumber,
        int stepNumber,
    ...
    /// <summary>
    /// Factory method to create a new QuestionTemplateV3
    /// </summary>
    public static QuestionTemplateV3 Create(
        int questionNumber,
        PersonaType? personaType,
        int stepNumber,
        string questionTextFR,
        ...
        string? icon)
    {
        var question = new QuestionTemplateV3(
            questionNumber,
            stepNumber,
            questionTextFR,
            questionTextEN,
