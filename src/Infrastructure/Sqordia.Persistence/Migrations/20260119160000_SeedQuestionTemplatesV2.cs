...
/// <inheritdoc />
public partial class SeedQuestionTemplatesV2 : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        // Section 1: Identity & Vision (Questions 1-4)
        ...
        // Section 2: The Offering (Questions 5-8)
        migrationBuilder.Sql($@"
            INSERT INTO ""QuestionTemplatesV2"" (""Id"", ""PersonaType"", ""StepNumber"", ""QuestionText"", ""QuestionTextEN"", ""HelpText"", ""HelpTextEN"", ""QuestionType"", ""Order"", ""IsRequired"", ""Section"", ""Icon"", ""IsActive"", ""Created"", ""IsDeleted"")
            VALUES
        ...
        // Section 3: Market Analysis (Questions 9-12)
        migrationBuilder.Sql($@"
            INSERT INTO ""QuestionTemplatesV2"" (""Id"", ""PersonaType"", ""StepNumber"", ""QuestionText"", ""QuestionTextEN"", ""HelpText"", ""HelpTextEN"", ""QuestionType"", ""Order"", ""IsRequired"", ""Section"", ""Icon"", ""IsActive"", ""Created"", ""IsDeleted"")
            VALUES
        ...
        // Section 4: Operations & People (Questions 13-16)
        migrationBuilder.Sql($@"
            INSERT INTO ""QuestionTemplatesV2"" (""Id"", ""PersonaType"", ""StepNumber"", ""QuestionText"", ""QuestionTextEN"", ""HelpText"", ""HelpTextEN"", ""QuestionType"", ""Order"", ""IsRequired"", ""Section"", ""Icon"", ""IsActive"", ""Created"", ""IsDeleted"")
            VALUES
        ...
        // Section 5: Financial (Questions 17-20)
        migrationBuilder.Sql($@"
            INSERT INTO ""QuestionTemplatesV2"" (""Id"", ""PersonaType"", ""StepNumber"", ""QuestionText"", ""QuestionTextEN"", ""HelpText"", ""HelpTextEN"", ""QuestionType"", ""Order"", ""IsRequired"", ""Section"", ""Icon"", ""IsActive"", ""Created"", ""IsDeleted"")
            VALUES
        ...
        // Set options for single choice question (Question 2)
        migrationBuilder.Sql(@"
            UPDATE ""QuestionTemplatesV2""
            SET ""Options"" = '[""Nouvelle startup"", ""Expansion"", ""Acquisition""]',
                ""OptionsEN"" = '[""New startup"", ""Expansion"", ""Acquisition""]'
            WHERE ""QuestionText"" = 'S''agit-il d''une nouvelle startup, d''une expansion ou d''une acquisition?';
        ");
    }
    ...
    {
        migrationBuilder.Sql(@"DELETE FROM ""QuestionTemplatesV2"" WHERE ""IsActive"" = true;");
    }
}
