...
namespace Sqordia.Persistence.Migrations
{
    ...
    [Migration("20260313001857_AddStartMonthSalesTaxFrequencyAndLegalForm")]
    partial class AddStartMonthSalesTaxFrequencyAndLegalForm
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sqordia.Domain.Entities.BusinessPlan.QuestionSectionMapping", b =>
                {
                    ...
                    b.HasIndex("QuestionTemplateId", "IsActive")
                        .HasDatabaseName("IX_QuestionSectionMappings_Question_Active");

                    b.HasIndex("QuestionTemplateId", "SubSectionId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Sqordia.Domain.Entities.NewsletterSubscriber", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
