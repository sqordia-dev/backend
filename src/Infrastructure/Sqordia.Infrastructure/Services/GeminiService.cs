...
public class GeminiService : IAIService
{
        ...
        ILogger<GeminiService> logger)
    {
        ...
        _logger.LogInformation("Gemini Settings - ApiKey configured: {HasKey}, Model: {Model}",
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var response = await _model.GenerateContent(combinedPrompt);
    ...
    public Task<bool> IsAvailableAsync(CancellationToken cancellationToken = default)
    {
        if (_model == null)
        {
            _logger.LogWarning("Gemini service unavailable: model is null");
            return Task.FromResult(false);
        }

        _logger.LogDebug("Gemini service is available");
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            return new SectionImprovementResponse
            {
                ...
                GeneratedAt = endTime,
                Confidence = 0.85,
                ImprovementExplanation = "Content improved by Gemini",
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            return new SectionExpansionResponse
            {
                ...
                GeneratedAt = endTime,
                Confidence = 0.85,
                ImprovementExplanation = "Content expanded by Gemini",
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            return new SectionSimplificationResponse
            {
                ...
                GeneratedAt = endTime,
                Confidence = 0.9,
                ImprovementExplanation = "Content simplified by Gemini",
                FurtherSuggestions = new List<string>(),
                WordCount = content.Split(' ').Length,
