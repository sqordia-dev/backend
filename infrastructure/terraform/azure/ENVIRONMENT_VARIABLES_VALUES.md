...
- **OPENAI_API_KEY**: `[SET VIA ENVIRONMENT VARIABLE OR AZURE KEY VAULT]`
- **OPENAI_MODEL**: `gpt-4o`
...
- **AzureCommunicationServices__ConnectionString**: `[SET VIA ENVIRONMENT VARIABLE OR AZURE KEY VAULT]`
...
- **GoogleOAuth__ClientSecret**: `[SET VIA ENVIRONMENT VARIABLE OR AZURE KEY VAULT]`
...
```hcl
# OpenAI Configuration
# IMPORTANT: Set this via environment variable or Azure Key Vault - DO NOT hardcode
openai_api_key = ""  # Set via TF_VAR_openai_api_key or Azure Key Vault
openai_model   = "gpt-4o"
...
3. **OpenAI API Key**: ⚠️ **SECURITY WARNING**: Never commit API keys to version control. Always use environment variables or Azure Key Vault for sensitive values.
